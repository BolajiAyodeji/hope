...
PROJECT_APPS = [
    ...
    "hope.apps.account.apps.AccountConfig",
    "hope.apps.core.apps.CoreConfig",
    "hope.apps.grievance.apps.GrievanceConfig",
    "hope.apps.household.apps.HouseholdConfig",
    "hope.apps.payment.apps.PaymentConfig",
    "hope.apps.program.apps.ProgramConfig",
    ...
    "hope.apps.web.apps.WebConfig",
    "hope.apps.periodic_data_update.apps.PeriodicDataUpdateConfig",
...
from hope.config.fragments.debug_toolbar import *  # noqa: F403, F401, E402
from hope.config.fragments.drf import *  # noqa: F403, F401, E402
from hope.config.fragments.drf_spectacular import *  # noqa: F403, F401, E402
